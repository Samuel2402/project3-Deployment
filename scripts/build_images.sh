...
docker build --no-cache -t samuel240210/petclinic-fe ./spring-petclinic-angular
...
docker build --no-cache -t samuel240210/petclinic-be ./spring-petclinic-rest
...
docker build --no-cache -t samuel240210/nginx ./NGINX
